                            ...
                            <div class="card-body card-block">
                                <form action="{{ route('editTask') }}" method="post">
                                    ...
                                    <div class="form-group"><label for="title"
                                            class=" form-control-label">Title</label><input type="text" id="company"
                                            name="title" value="{{ $t->title }}" placeholder="Enter task title"
                                    ...
                                    <div class="form-group"><label for="description"
                                            ...
                                            placeholder="Enter description for task" class="form-control"></div>
                                    ...
                                    <div class="form-group"><label for="progress"
                                            class=" form-control-label">Progress</label><input type="number" id="progress"
                                            name="progress" value="{{ $t->progress }}" placeholder="Progress %"
                                            class="form-control"></div>
