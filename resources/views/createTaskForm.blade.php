                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="{{ route('createNewTask') }}" method="post">
                                {{ csrf_field() }}
                                <div class="form-group"><label for="title" class=" form-control-label">Title</label><input
                                ...
                                <div class="form-group">
                                    <div class="col col-md-3"><label for="select" class=" form-control-label">Status</label>
                                    </div>
                                ...
                                <div class="form-group"><label for="progress"
                                        ...
                                        name="progress" placeholder="Progress %" class="form-control"></div>
